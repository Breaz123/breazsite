...
export const metadata: Metadata = {
  title: 'Funnelanalyse & Conversieoptimalisatie | Breaz - Verkoop begint bij luisteren',
  description:
    'Breaz analyseert je salesfunnel en identificeert waar kansen liggen om meer prospects om te zetten in klanten.',
  openGraph: {
    type: 'website',
    locale: 'nl_BE',
    url: 'https://www.breaz.be/diensten/sales/funnelanalyse-conversieoptimalisatie',
    siteName: 'Breaz',
    title: 'Funnelanalyse & Conversieoptimalisatie | Breaz - Verkoop begint bij luisteren',
    description:
    ...
    images: [
      {
        url: '/og-breaz-funnelanalyse.jpg',
        width: 1200,
        height: 630,
        alt: 'Breaz Funnelanalyse & Conversieoptimalisatie',
      },
    ],
  },
}
...
const problem = {
  title: 'Het probleem',
  subtitle: 'Waarom verliezen bedrijven klanten?',
  description:
    'De meeste bedrijven verliezen 70-90% van hun leads ergens in de salesfunnel. Ze weten niet waar, waarom of hoe ze dit kunnen oplossen. Het resultaat? Gemiste kansen, gefrustreerde teams en dalende omzet.',
  painPoints: [
    'Leads die verdwijnen zonder duidelijke reden',
    'Lange salescycli zonder duidelijkheid over de volgende stap',
    'Inconsistentie in verkoopresultaten tussen teamleden',
    'Geen inzicht in waar het proces vastloopt',
    'Marketing en sales die niet op één lijn zitten',
    'Objecties die steeds terugkomen zonder oplossing',
  ],
}
...
const agitation = {
  ...
  description:
    'Elke verloren lead is niet alleen een gemiste verkoop, maar ook een gemiste kans om je bedrijf te laten groeien. De kosten lopen op:',
  consequences: [
    {
      icon: TrendingUp,
      title: 'Dalende omzet',
      description: 'Elke maand verlies je duizenden euro\'s aan potentiële omzet die je had kunnen realiseren.',
    },
    {
      icon: Users,
      title: 'Frustrerende ervaringen',
      description: 'Je team raakt gedemotiveerd door het gebrek aan duidelijkheid en resultaten.',
    },
    {
      icon: Eye,
      title: 'Gemiste kansen',
      description: 'Je ziet niet welke leads écht geïnteresseerd zijn en waar je je energie op moet richten.',
    },
    {
      icon: AlertTriangle,
      title: 'Concurrentievoordeel verliezen',
      description: 'Terwijl jij worstelt met je funnel, wint de concurrentie klanten die jij had kunnen hebben.',
    },
  ],
}
...
const solution = {
  title: 'De oplossing',
  subtitle: 'Hoe wij je funnel optimaliseren',
  description:
    'Wij brengen structuur en inzicht in je salesproces. Door data-gedreven analyse en menselijke inzichten te combineren, helpen we je om meer leads om te zetten in klanten.',
  approach: [
    {
      icon: Search,
      title: 'Funnel Mapping',
      description: 'We brengen je hele salesproces in kaart, van eerste contact tot gesloten deal.',
    },
    {
      icon: BarChart3,
      title: 'Data Analyse',
      description: 'We analyseren waar leads verdwijnen en identificeren de grootste verbeterkansen.',
    },
    {
      icon: Filter,
      title: 'Lead Scoring',
      description: 'We ontwikkelen een systeem om de beste leads te identificeren en prioriteren.',
    },
    {
      icon: MousePointer,
      title: 'Conversie Optimalisatie',
      description: 'We testen en verbeteren elke stap in je funnel voor maximale conversie.',
    },
    {
      icon: Activity,
    ...
    },
    {
      ...
      description: 'We zorgen voor duidelijke inzichten en continue monitoring van je resultaten.',
    },
  ],
}
...
const outcome = {
  ...
  description:
    'Na onze funneloptimalisatie heb je een salesproces dat werkt. Je team weet precies wat te doen, wanneer en hoe. Het resultaat: meer deals, kortere cycli en een gemotiveerd team.',
  results: [
    'Hogere conversieratio\'s in elke fase van je funnel',
    'Kortere salescycli door duidelijkere processen',
    'Meer kwalitatieve leads door betere scoring',
    'Minder verloren leads door geoptimaliseerde follow-up',
    'Betere samenwerking tussen marketing en sales',
    'Meetbare verbeteringen in je verkoopresultaten',
  ],
  metrics: [
    { label: 'Conversie verbetering', value: '25-40%' },
    { label: 'Kortere salescyclus', value: '30-50%' },
    { label: 'Meer kwalitatieve leads', value: '60-80%' },
    { label: 'Hogere team motivatie', value: '85%' },
  ],
}

export default function FunnelanalysePage() {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
                ...
                <span>Funnelanalyse & Conversieoptimalisatie</span>
              </div>
            </FadeIn>
            <FadeIn delay={0.1}>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Meer leads omzetten in{' '}
            ...
            <FadeIn delay={0.2}>
              <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                We analyseren je salesfunnel en identificeren waar kansen liggen om meer prospects 
                om te zetten in klanten. Van data-analyse tot procesoptimalisatie.
              </p>
            </FadeIn>
            <FadeIn delay={0.3}>
                ...
                <div className="relative overflow-hidden border-0 shadow-2xl rounded-3xl backdrop-blur-md bg-white/10 border border-white/20 group-hover:bg-white/15 transition-all duration-500">
                  <div className="p-12 sm:p-16 text-center text-white">
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
                      Klaar om je funnel te optimaliseren?
                    </h2>
                    <p className="text-lg sm:text-xl mb-10 opacity-95 max-w-2xl mx-auto leading-relaxed">
                      Laten we samen kijken waar je salesfunnel vastloopt en hoe we meer leads kunnen omzetten in klanten.
                    </p>
